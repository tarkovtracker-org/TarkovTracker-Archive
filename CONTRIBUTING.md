...
- **Talk to us** – For substantial changes (e.g., major refactors, architectural changes), start a [GitHub Discussion](https://github.com/tarkovtracker-org/TarkovTracker/discussions), chat in the [TarkovTracker Discord](https://discord.gg/zeAP4Ng), or open an issue to align with the maintainers before investing significant time.
...
- Ask implementation questions in [Discussions](https://github.com/tarkovtracker-org/TarkovTracker/discussions) under the `Q&A` category or in the development channels on the [TarkovTracker Discord](https://discord.gg/zeAP4Ng).
