...
- **Talk to us** – For substantial changes (e.g., major refactors, architectural changes), start a [GitHub Discussion](https://github.com/TarkovTracker/tarkovtracker/discussions), chat in the [TarkovTracker Discord](https://discord.gg/M8nBgA2sT6), or open an issue to align with the maintainers before investing significant time.
...
## Getting help
- Ask implementation questions in [Discussions](https://github.com/TarkovTracker/tarkovtracker/discussions) under the `Q&A` category or in the development channels on the [TarkovTracker Discord](https://discord.gg/M8nBgA2sT6).
