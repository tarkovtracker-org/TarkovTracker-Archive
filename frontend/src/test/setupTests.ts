...
// Add safe guards for window and document globals
if (!global.window) {
...
// Stub localStorage and sessionStorage if they don't exist
...
// Prevent Firebase Functions initialization in component tests
