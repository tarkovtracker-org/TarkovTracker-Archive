...
function checkGitStatus() {
  ...
  if (hasChanges) {
    ...
    log('  3. Commit the updated files: git add functions/openapi/ frontend/public/api/', colors.green);
    log('  4. Include in your commit: git commit --amend or git commit -m "docs: update OpenAPI spec"', colors.green);
    ...
    log('\n' + '─'.repeat(70), colors.red);
    log('CI Check Failed: Commit the regenerated OpenAPI files to pass.', colors.bright + colors.red);
    log('─'.repeat(70) + '\n', colors.red);
