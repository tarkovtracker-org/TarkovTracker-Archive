...
Please use the new repository instead: [TarkovTracker](https://github.com/TarkovTracker-org/TarkovTracker)
...
- **Live chat & squads** – Join the [TarkovTracker Discord](https://discord.gg/M8nBgA2sT6) to coordinate raids, ask questions in real time, or hang out with fellow Tarkov fans.
